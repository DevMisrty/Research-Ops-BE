...
public interface ResearcherService {
    void createResearchProfile(String token, RegisterResearcherRequestDto requestDto) throws BadRequestException, TokenExpireException;

    Page<CaseDto> getListOfAssignedCases(int page, int limit, String sortBy, String dir,String searchBy, String email);
